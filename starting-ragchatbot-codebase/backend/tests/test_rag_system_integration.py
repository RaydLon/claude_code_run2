...
class TestRAGSystemInitialization:
    ...
    def test_working_rag_system_initializes_with_correct_max_results(self, working_config):
        """
...
class TestRAGSystemSessionManagement:
    ...
    def test_working_system_creates_session_history(
        ...
        response1, sources1 = rag_system.query("What is computer use?", session_id=session_id)

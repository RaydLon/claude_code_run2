...
class CourseOutlineTool(Tool):
    """Tool for retrieving course outlines with all lessons"""
        ...
        return {
            ...
            "input_schema": {
                ...
                "properties": {
                    "course_name": {
                        "type": "string",
                        "description": "Course title or partial name to get the outline for (e.g., 'MCP', 'Introduction')",
                    }
                },
    ...
    def execute(self, course_name: str) -> str:
        ...
        try:
            ...
            # Format the outline
            formatted_parts = [f"Course: {course_title}", f"Link: {course_link}", "\nLessons:"]

            for lesson in lessons:
                lesson_num = lesson.get("lesson_number")
                lesson_title = lesson.get("lesson_title", "Untitled")
                formatted_parts.append(f"  Lesson {lesson_num}: {lesson_title}")

            # Store source information
            self.last_sources = [{"text": course_title, "url": course_link}]
